...
- Finished the code in fully and tested it intensively to work. 
- Made the hardware part more cleanear making it easier to to see the connected pins and the architecture. 
